...
> **CF-1A3A — Complete targeted DB/security, browser, CI, Runtime Validation, and Sprint Validation certification on the exact feature head.**
...
CF-1A2 entitlement and seat foundations are certified and merged. CF-1A3A implements server-backed activation credentials, lifecycle controls, and the Platform Admin commercial control plane; complete its exact-head certification before architectural review. Do not begin CF-1A3B or Sprint 26.
