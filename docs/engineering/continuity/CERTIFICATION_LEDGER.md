...
This ledger separates immutable product commits from later merge or continuity-only commits. A PR description is historical evidence, not a substitute for an immutable workflow result. Private-corpus results are identified as historical when the protected corpus was unavailable for an independent rerun.
...
| Sprint 25 post-merge correction | Draft PR #28, product commit `77b631f2b011c6ce8603e5de5aef12202f7f4d22`; certification-test head `05eea8abe7c071c4476c1984f77b49db85680551` | Product tree `9f9ef73811a5c04ea30cd017fcb07b57ead75e3c`; certification-test tree `507ba1037eba781f4e37ad07676572e2ea6494d9`; not merged | 421/421 across 41 suites; 47/47 Playwright. Supplemental local audit verified all 143 crown tests across 11 suites. | Protected corpus absent; no rerun claim | CI `31849913854`; Runtime `31849913798`; Sprint `31849913825`; all pass on `05eea8a` | Public corrective candidate certified. A later continuity-only head must retain green workflows and architectural review is still required. Sprint 26 remains blocked. |
