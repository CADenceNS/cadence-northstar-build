...
import { CROWN_TOOL_COVERAGE_REGISTRY } from './crown-tool-registry';
...
export const UNIVERSAL_TOOL_COVERAGE_REGISTRY = [...TOOL_COVERAGE_REGISTRY, ...MARGIN_TOOL_COVERAGE_REGISTRY, ...CROWN_TOOL_COVERAGE_REGISTRY] as const;
