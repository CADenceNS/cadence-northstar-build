...
type CaseResolver = (caseId:string)=>Promise<ClinicalCase|null>;
type CaseUpdater = (caseId:string, value:ClinicalCase)=>Promise<void>;

export function createQcEngine(app: Express, now: () => string, resolveCase:CaseResolver, updateCase:CaseUpdater) {
