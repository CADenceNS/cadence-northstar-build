...
export const defaultTenantId=process.env.NORTHSTAR_TENANT_ID??'00000000-0000-0000-0000-000000000001';
...
export async function createDurableRuntime(){
 ...
 await pool.query("INSERT INTO tenants(id,name) VALUES ($1,'Keramos Dental Laboratory') ON CONFLICT (id) DO NOTHING",[defaultTenantId]);
