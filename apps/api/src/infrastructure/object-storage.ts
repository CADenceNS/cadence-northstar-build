...
export type StoredObjectKind='stl'|'obj'|'ply'|'dicom'|'cbct'|'xray'|'clinical-photo'|'shade-photo'|'qc-photo'|'uat-screenshot'|'rx-pdf'|'intake-document'|'intake-package'|'prescription-pdf'|'shipping-document'|'invoice-pdf';
