...
('SLP-EMA','SLP','SLP-EMA','Elastic Mandibular Advancement Appliance','Elastic Mandibular Advancement Appliance','sleep','Sleep Appliances','PER_PRODUCT',NULL,'{"selection":"BOTH_ARCHES","allowedArches":["both"]}'),
...
('WUP-DIG','DIA','DIA-WUP','Diagnostic Wax-Up: Digital Milled/Printed','Diagnostic Wax-Up: Digital Milled/Printed','diagnostics','Diagnostics & Digital','PER_UNIT',NULL,'{"selection":"MULTIPLE_TEETH","allowedArches":["upper","lower","both"]}'),
